          ...
          <div className="relative">
            ...
            <div className="relative w-full h-[28rem] flex flex-col items-center justify-center -mt-4 gap-0">
              <img 
                ...
                className="w-full max-w-[22rem] sm:max-w-[26rem] lg:max-w-[30rem] object-contain drop-shadow-[0_22px_48px_rgba(59,130,246,0.45)] transition-transform duration-500 ease-out translate-y-[10.25rem]"
              />
              <img 
                src="/hero-logo-lower.png"
                alt="MyPartsRunner wordmark"
                className="w-full max-w-[24rem] sm:max-w-[28rem] lg:max-w-[34rem] object-contain drop-shadow-[0_18px_40px_rgba(56,189,248,0.45)] transition-transform duration-500 ease-out -translate-y-[10.25rem]"
              />
            </div>
          </div>
        </div>
