          ...
          <div className="relative">
            ...
            <div className="relative w-full flex flex-col items-center justify-center -mt-4">
              ...
              <img 
                ...
                className="w-full max-w-[32rem] sm:max-w-[36rem] lg:max-w-[42rem] object-contain drop-shadow-[0_18px_40px_rgba(56,189,248,0.45)] transition-transform duration-500 ease-out -translate-y-[29rem]"
              />
            </div>
          </div>
        </div>
