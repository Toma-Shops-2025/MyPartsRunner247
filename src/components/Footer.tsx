        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><button onClick={() => handleNavigation('/services')} className="text-gray-400 hover:text-white transition-colors text-left">Services Overview</button></li>
              <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Personal Pickups</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Merchant Delivery</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Emergency Runs</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Scheduled Delivery</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><button onClick={() => handleNavigation('/security')} className="text-gray-400 hover:text-white transition-colors text-left">Security & Compliance</button></li>
